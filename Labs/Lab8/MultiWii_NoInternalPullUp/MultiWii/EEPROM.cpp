...
void LoadDefaults() {
  uint8_t i;
  ...
  #else
	  #if PID_CONTROLLER == 1
      conf.pid[ROLL].P8     = 22;  conf.pid[ROLL].I8    = 20; conf.pid[ROLL].D8     = 13;
      conf.pid[PITCH].P8    = 22; conf.pid[PITCH].I8    = 20; conf.pid[PITCH].D8    = 13;
      conf.pid[PIDLEVEL].P8 = 6; conf.pid[PIDLEVEL].I8 = 8; conf.pid[PIDLEVEL].D8 = 3;
    ...
    #endif
    conf.pid[YAW].P8      = 28;  conf.pid[YAW].I8     = 12;  conf.pid[YAW].D8     = 6;
    ...
    conf.pid[PIDVEL].P8 = 6;      conf.pid[PIDVEL].I8 = 8;    conf.pid[PIDVEL].D8 = 3;

    conf.rcRate8 = 43; conf.rcExpo8 = 00;
	conf.rollPitchRate = 40;
	conf.yawRate = 40;
	conf.dynThrPID = 0;
	conf.thrMid8 = 00; conf.thrExpo8 = 00;
