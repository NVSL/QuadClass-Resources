# Bare Bones Board Assembly Drawings

Below are the assembly drawings for the BBB.  For each part, the locations of the parts on the board are highlighted.
...
![images/bbb-pwrswitch.png](images/bbb-pwrswitch.png)
