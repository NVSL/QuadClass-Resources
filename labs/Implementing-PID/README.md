...
Initially, you can ignore this problem: Set test with your throttle in the middle or so.
...
* Use the knobs and buttons on your remote to tune parameters. It’s much faster than recompiling.
...
When you encounter a problem in this lab, it really pays off to be methodical about how you track down the underlying cause.  Here is what I recommend (and what I will have you do if you ask me for help):

0.  How's your battery?
1.  How powerful are your motors?
2.  Check your raw IMU measurements -- are they reasonable?
3.  Check your filtered IMU measurements -- are they not-so-noisy when the motors are on?
4.  Check your error calculation -- Does it change correctly when you tilt the FCB?  Does it change correctly when you move the pitch stick?
5.  Does it behave sensibly with just P?  Are your kP a reasonable value?
6.  Check your derivative calculation -- Does it match up with your error calculation?  Is dT in the right units?
7.  Does it behave sensibly with P and D?  ARe your kD and KP reasonable values?
8.  Check your integral calculation -- Do you handle wind up correctly?  Is dT in the right units?
9.  Does it behave sensible with PID? Is kI a reasonable value?
